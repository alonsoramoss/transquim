...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className="w-full h-20 fixed top-0 transition-colors duration-300 z-50 px-5 bg-[#ff8000] backdrop-blur-md shadow-lg">
        <div className="w-full h-full flex items-center justify-between mx-auto">
          ...
          <div className="hidden md:flex md:w-[500px] h-full items-center justify-between mx-16">
            <nav className={`${sora.className} flex items-center justify-between w-full h-auto px-5 text-neutral-950 dark:text-neutral-50`}>
