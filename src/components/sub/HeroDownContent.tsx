...
const HeroDownContent=()=> {
  return (
    <section className="h-full w-full flex flex-col items-center max-w-[1440px] px-5 py-20 mx-auto">
      <h2 id="nosotros" className="text-center text-3xl md:text-4xl lg:text-5xl font-bold py-16 md:py-20">
        ¿Por qué elegir <strong><MagicText>TRANSQUIM</MagicText></strong>?
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="card-item p-4 pt-8 bg-neutral-50 dark:bg-blue-950">
          ...
          <strong className="text-lg mb-2 text-orange-500">Calidad Garantizada</strong>
        ...
        <div className="card-item p-4 pt-8 mt-8 md:mt-0 bg-neutral-50 dark:bg-blue-950">
          ...
          <strong className="text-lg mb-2 text-orange-500">Experiencia y Confianza</strong>
        ...
        <div className="card-item p-4 pt-8 mt-8 md:mt-9 lg:mt-0 bg-neutral-50 dark:bg-blue-950">
          ...
          <strong className="text-lg mb-2 text-orange-500">Alcance Global</strong>
        ...
        <div className="card-item p-4 pt-8 mt-8 md:mt-9 lg:mt-0 bg-neutral-50 dark:bg-blue-950">
          ...
          <strong className="text-lg mb-2 text-orange-500">Compromiso con la Sostenibilidad</strong>
