...
const Ubicacion = () => {
  return (
    <div className="flex flex-col items-center text-center py-20" id="ubicacion">
      ...
      <div className="h-1 w-32 my-8 bg-indigo-500 animate-pulse rounded" />
      <div className="flex flex-wrap items-center justify-center w-full mx-auto max-w-[1500px] px-5">
        ...
        width="100%" height="500" style={{border:0}} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
  );
